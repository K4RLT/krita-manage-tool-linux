...
class SettingsManager(JsonManage):
    def __init__(self):
        ...
        default_settings = {
            ...
            'config_save_path': platform_dependence.get_default_save_path(),
...
class ConfigManager(JsonManage):
    def __init__(self):
        ...
        # 配置文件路径: ~/Documents/krita-config-tool/configs.json
        config_dir = os.path.expanduser('~/Documents/krita-config-tool')
